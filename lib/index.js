...
var events = exports.events = {
  ...
  , 1024: "monitor_stopped" // zmq.ZMQ_EVENT_MONITOR_STOPPED
  , 2048: "handshake_failed" // zmq.ZMQ_EVENT_HANDSHAKE_FAILED
  , 4096: "handshake_succeed" // zmq.ZMQ_EVENT_HANDSHAKE_SUCCEED
}
...
Socket.prototype.monitor = function(interval, numOfEvents) {
  if (zmq.ZMQ_CAN_MONITOR) {
    ...
    self._zmq.onMonitorEvent = function(event_id, event_value, event_endpoint_addr, ex, remote_addr) {
      self.emit(events[event_id], event_value, event_endpoint_addr, ex, remote_addr);
    }
